...
const imageLinks = [
  {
    url: "https://www.freepik.com/free-photo/autumn-ottawa-valley_10759308.htm",
    description: "Autumn Ottawa Valley",
  },
  {
    url: "https://www.freepik.com/free-photo/different-people-doing-volunteer-work-with-food_15574043.htm",
    description: "Volunteers with Food",
  },
  {
    url: "https://www.freepik.com/free-photo/detailed-view-charity-workers-helping-homeless-refugees-needy-people-by-distributing-free-food-friendly-volunteers-serving-meals-offering-support-sharing-non-perishable-items_77149772.htm",
    description: "Charity workers helping",
  },
  {
    url: "https://www.freepik.com/free-photo/people-sharing-feelings-emotions-group-therapy-session_94668827.htm",
    description: "Group therapy session",
  },
  {
    url: "https://www.freepik.com/free-photo/group-volunteers-collecting-garbage_2169918.htm",
    description: "Volunteers collecting garbage",
  },
  {
    url: "https://www.freepik.com/free-photo/african-social-worker-taking-care-senior-woman_16137222.htm",
    description: "Senior care worker",
  },
  {
    url: "https://www.freepik.com/free-photo/tech-people-trying-achieve-ambitious-sustainability-goals_80756751.htm",
    description: "Sustainability goals",
  },
  {
    url: "https://www.freepik.com/free-photo/team-supporters-celebrating-tailgate-party_18412130.htm",
    description: "Community event celebration",
  },
];

// Resource links (shortened version of your array)
const resources = [
  {
...
const ReferencesPage = () => {
  return (
    <motion.div
      id="referencesExplore"
      className="min-h-screen bg-white px-4 md:px-10 py-10"
      variants={container}
      initial="hidden"
      animate="show"
    >
      ...
      <motion.div className="mb-12 text-center" variants={item}>
        ...
        <ul className="list-disc list-inside space-y-2 text-blue-700">
          <li>
            <a
              href="https://acrobat.adobe.com/id/urn:aaid:sc:US:62c87c1c-ee35-4c84-89e4-22a2140f53a0"
              target="_blank"
          ...
          <li>
            <a
              href="https://acrobat.adobe.com/id/urn:aaid:sc:US:7b2ba350-b247-41f6-9110-05ce69948ea3"
              target="_blank"
              rel="noopener noreferrer"
              className="underline hover:text-blue-900"
            >
