...
//         About Chesco Connect
//       </motion.h1>
//       <motion.p variants={item} className="text-3xl text-blue-700 w-200">
//         Built for residents, nonprofits, and volunteers, Chesco Connect
//         strengthens local connections and community impact.
//       </motion.p>
